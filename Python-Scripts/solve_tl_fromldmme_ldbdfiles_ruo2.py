...
tmax = 0
xmax = 0
dirv = 0 # direction of velocity, 0 - x, 1 - y, 2 - z
...
latt.init(valley)
elec = electron()
elec.init(latt, excess_density, mu, scale_coh, Bext, renorm_spinpert, trunc_outer, dirv) #, if_reset_erange, nkbt)
eph = electron_phonon()
...
# for RuO2
tlRR.solve_tl_fromldmme_RayleighRitz("rate", -eph.L, None, UR_RR, UR_RR, np.arange(1,2,dtype=np.int32), "", False, "smallest real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("rate", -eph.L, None, UL_RR, UR_RR, np.arange(1,2,dtype=np.int32), "with Left", False, "smallest real abs")
# for RuO2
...
# for RuO2
UL_l_RR, UR_l_RR = setU_RayleighRitz_forLength(orthnorm_URR, ob_scale.T, rhopert.T, eph.L, elec.Lv, 1, elec.nmode)
UL_l_RR_2, UR_l_RR_2 = setU_RayleighRitz_forLength(orthnorm_URR, ob_scale.T, rhopert.T, eph.L, elec.Lv, 3, elec.nmode)
...
# for ruo2
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR, UR_l_RR, np.array([0,1],np.int32), "sx vsx", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR, UR_l_RR, np.array([0,1],np.int32), "sx vsx, with Left", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR, UR_l_RR, np.array([0,1,2,3],np.int32), "", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR, UR_l_RR, np.array([0,1,2,3],np.int32), "with Left", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR, UR_l_RR, np.array([0,1,2,3,4,5],np.int32), "", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR, UR_l_RR, np.array([0,1,2,3,4,5],np.int32), "with Left", True, "smallest inv real abs")

# DD model based on EY spin lifetime
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR_2, UR_l_RR_2, np.array([0,3],np.int32), "sx vsx", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR_2, UR_l_RR_2, np.array([1,4],np.int32), "sy vsy", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR_2, UR_l_RR_2, np.array([2,5],np.int32), "sz vsz", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR_2, UR_l_RR_2, np.array([0,3],np.int32), "sx vsx, with Left", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR_2, UR_l_RR_2, np.array([1,4],np.int32), "sy vsy, with Left", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR_2, UR_l_RR_2, np.array([2,5],np.int32), "sz vsz, with Left", True, "smallest inv real abs")
