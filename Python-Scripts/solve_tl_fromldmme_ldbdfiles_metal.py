...
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UR_l_RR, UR_l_RR, np.array([0,1,4,5],np.int32), "", True, "smallest inv real abs")
tlRR.solve_tl_fromldmme_RayleighRitz("lambda inv", elec.Lv, -eph.L, UL_l_RR, UR_l_RR, np.array([0,1,4,5],np.int32), "with Left", True, "smallest inv real abs")
